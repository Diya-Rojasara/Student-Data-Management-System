...
$sid=$row['school_id'];
echo "<tr>";
echo "<th width='50%'>Student's Name(as per School Record)</th>";
echo "<td width='50%'>" .  $row['student_name'] . "</td>";
echo "</tr>";
...
<a href="class-wise2.php?class=<?php print $class;?>&sid=<?php print $sid;?>"><button class="btn btn-primary btn-sm mt89" tabindex="0" style="font-size:1.2em"> Back to Student Dashboard</button></a>
