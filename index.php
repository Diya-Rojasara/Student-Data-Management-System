                              ...
                              <div class="table_section padding_infor_info">
                                 <div class="table-responsive-sm">
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "1";?>"><button  name="as1" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "2";?>"><button  name="as2" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "3";?>"><button  name="as3" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "4";?>"><button  name="as4" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "5";?>"><button  name="as5" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "6";?>"><button  name="as6" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "7";?>"><button  name="as7" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center;"><a href="st_data_add.php?sid=<?php print $sid;?>&class=<?php print "8";?>"><button  name="as8" style="font-size:1.2em;" class="btn btn-info">Add Student</button></a></td>
