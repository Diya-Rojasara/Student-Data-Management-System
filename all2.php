...
<thead>
					...
					school_login ON general_profile.school_id=school_login.school_id
					 where class_of_last_year>=1 AND school_code LIKE '$str%' ORDER BY enrolmnt_details.class_of_last_year ASC";
					...
					INNER JOIN
					school_login ON general_profile.school_id=school_login.school_id
					where class_of_last_year='Anganwadi' AND school_code LIKE '$str%'";
...
<a href="dindex.php"><button class="btn btn-secondary btn-sm mt89" tabindex="0" style="font-size:1.2em"> Back to School Dashboard</button></a>
