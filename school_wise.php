                           ...
                           <div class="white_shd full margin_bottom_30">
                              <div class="table_section padding_infor_info">
                                 <div class="table-responsive-sm">
									...
									$res=mysqli_query($cn,$q);
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             <td style="text-align:center;"><a href="class-wise2.php?class=<?php print "1";?>&sid=<?php print $sid;?>"><button name="vm1" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$res=mysqli_query($cn,$q);
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "2";?>&sid=<?php print $sid;?>"><button name="vm2" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$res=mysqli_query($cn,$q);
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "3";?>&sid=<?php print $sid;?>"><button name="vm3" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "4";?>&sid=<?php print $sid;?>"><button name="vm4" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "5";?>&sid=<?php print $sid;?>"><button name="vm5" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "6";?>&sid=<?php print $sid;?>"><button name="vm6" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "7";?>&sid=<?php print $sid;?>"><button name="vm7" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
									...
									$data=mysqli_fetch_assoc($res);echo $data['total'];?></td>
                                             ...
                                             <td style="text-align:center"><a href="class-wise2.php?class=<?php print "8";?>&sid=<?php print $sid;?>"><button name="vm8" class="btn btn-info" style="font-size:1.2em;">View</button></a></td>
											 
                                             
                                          </tr>
                                       </tbody>
                                    </table>
									<a href="dindex.php"><button type="button" style="font-size:2em;" class="btn btn-secondary">Back</button></a>
