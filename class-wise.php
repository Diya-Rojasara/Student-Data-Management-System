...
<tr>
                                             ...
                                             <td><a href="view_students.php?s_gp_id=<?php print $s_gp_id;?>&class=<?php print $class1;?>"><input type="button" class="btn btn-primary" value="View" style="font-size:1.2em"></a></td>
                                             <td><a href="update_students.php?s_gp_id=<?php print $s_gp_id;?>&class=<?php print $class1;?>&sid=<?php print $sid;?>"><input type="button" class="btn btn-success" value="Edit" style="font-size:1.2em"></a></td>
                                             <td><a href="delete_students.php?s_gp_id=<?php print $s_gp_id;?>&class=<?php print $class1;?>&sid=<?php print $sid;?>"><input type="button" class="btn btn-danger" value="Delete" style="font-size:1.2em" onclick="return confirm('Are you sure want to delete?')"></a></td>
