...
<thead>
					...
					INNER JOIN
					enrolmnt_details ON general_profile.s_gp_id=enrolmnt_details.s_gp_id where school_id=$sid AND class_of_last_year>=1 ORDER BY enrolmnt_details.class_of_last_year ASC";
					$q1="select general_profile.s_gp_id,student_name,gender,sid,
					enrolmnt_details.class_of_last_year,
					enrolmnt_details.rollno
					from general_profile 
					INNER JOIN
					enrolmnt_details ON general_profile.s_gp_id=enrolmnt_details.s_gp_id where school_id=$sid AND class_of_last_year='Anganwadi'";
